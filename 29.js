...
const serverUrl = "https://d7871bd1b67a.ngrok.io";
...
function checkOut() {
  ...
  if (serverIsRunning) {
    checkoutButton[0].onclick = (e) => {
      e.preventDefault();
      axios
        .post(`${serverUrl}/custom-checkout`, {
          // or 'PUT'
          products,
          shopDomain,
        })
