...
let hostedUrl = "https://1f98632dde17.ngrok.io";
...
function start() {
  ...
  function renderWidget() {
    ...
    current_Product_VariantIds.forEach((id) => applicableDiscounts(id));
