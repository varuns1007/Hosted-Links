...
function selectWidgetLocation() {
  ...
  function position(pos, node) {
    ...
    // console.log(obj);
    axios
      .post("https://0360d53c9e0c.ngrok.io/widgetSave", {
...
function checkOut() {
  ...
  checkoutButton[0].onclick = (e) => {
    e.preventDefault();
    axios
      .post("https://0360d53c9e0c.ngrok.io/custom-checkout", {
        // or 'PUT'
        products,
        shopDomain,
      })
    ...
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        if (event.target.classList[0] === "clicked") {
          ...
          axios
            .post("https://0360d53c9e0c.ngrok.io/subtotalSave", {
              className: className,
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://0360d53c9e0c.ngrok.io/totalSave", {
            className: className,
            tagName: event.target.tagName.toLowerCase(),
            shopName: shopDomain,
          })
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://0360d53c9e0c.ngrok.io/individualSave", {
            className: className,
            tagName: event.target.tagName.toLowerCase(),
            shopName: shopDomain,
          })
...
function renderWidget() {
  axios
    .post("https://0360d53c9e0c.ngrok.io/userData", {
      username: shopDomain,
    })
    .then((response) => {
