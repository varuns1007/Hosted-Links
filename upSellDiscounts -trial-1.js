...
function start() {
  ...
  function productPagePopUp() {
    ...
    function openUpSellChild(index, path) {
      console.log(offers[index]);
      let offer = offers[index];
      let currentOffer = "";
      if (path === "A-A") {
        currentOffer =
          offer.downsellCondition.offerAccepted.downsellCondition.offerAccepted;
      } else if (path === "D-A") {
        currentOffer =
          offer.downsellCondition.offerDeclined.downsellCondition.offerAccepted;
      }
      ...
      if (currentOffer.isExists && !currentOffer.skip_offer) {
        ...
        if (currentOffer.discount.type === "Discount") {
          if (currentOffer.discount.discountType === "INR") {
            discount = `Deal unlocked! Get this product for ${superAssistantUser2_shopifyCurrency} ${currentOffer.discount.discountValue}  off`;

            let discountPrice = String(
              parseFloat(originalPrice) -
                parseFloat(currentOffer.discount.discountValue)
            );
            discountedPrice = `<del style="color: grey; font-weight: 600">${superAssistantUser2_shopifyCurrency} ${originalPrice} </del>
            <ins style="text-decoration: none; color: #d94e72; font-weight: 600">
            ...
            discount = `Deal unlocked! Get this product for ${currentOffer.discount.discountValue}%  off`;
          ...
          totalDiscount = `<p style="font-size: 0.9em">Quickly grab this amazing deal!</p>`;
        }
...
>
  ...
  <div style="padding: 1em; text-align: center">
    ...
    <div style="display: flex; flex-direction: row; padding-top: 1em; gap: 1em">
      <button
        style="
          padding: 1em 2em;
          font-weight: 600;
    ...
    function openDownSellChild(index, path) {
      console.log(offers[index]);
      let offer = offers[index];
      let currentOffer = "";
      if (path === "A-D") {
...
>
  ...
  <div style="padding: 1em; text-align: center">
    ...
    function openUpSellParent(index) {
      console.log(offers[index]);
      //close parent modal
  ...
  <div style="padding: 1em; text-align: center">
    ...
    <div style="display: flex; flex-direction: row; padding-top: 1em; gap: 1em">
      <button
        ...
        onclick="openUpSellChild(INDEX,'A-A')"
      >
        Accept Offer
      </button>
      <button
    ...
    function openDownSellParent(index) {
      console.log(offers[index]);
...
>
  ...
  <div style="padding: 1em; text-align: center">
    ...
    <div style="display: flex; flex-direction: row; padding-top: 1em; gap: 1em">
      <button
        ...
        onclick="openUpSellChild(INDEX,'D-A')"
      >
        Accept Offer
      </button>
      <button
  ...
  <div style="padding: 1em; text-align: center">
        ...
        >
          <button
                ...
                onclick="openUpSellParent(INDEX)"
              >
                Accept Offer
              </button>
              <button
  ...
  `;
      slideData = slideData.replace(
        /discountPercentage|offerTime|productName|discountedPrice|totalDiscount|freeShipping|productImage|optionsList|INDEX/gi,
        function (matched) {
          return obj[matched];
        }
      );
...
>
  ...
  <div style="padding: 1em; text-align: center">
    ...
    function openUpSellParent(index) {
      ...
      let offer = offers[index];
      let currentOffer = offer.downsellCondition.offerAccepted;
      console.log(offer.downsellCondition.offerAccepted.isExists);
      console.log(!offer.downsellCondition.offerAccepted.skip_offer);
      console.log(
        offer.downsellCondition.offerAccepted.isExists &&
          !offer.downsellCondition.offerAccepted.skip_offer
      );
...
>
  ...
  <div style="padding: 1em; text-align: center">
    ...
    function openDownSellParent(index) {
      ...
      let offer = offers[index];
      let currentOffer = offer.downsellCondition.offerDeclined;
      console.log(offer.downsellCondition.offerDeclined.isExists);
      console.log(!offer.downsellCondition.offerDeclined.skip_offer);
      console.log(
        offer.downsellCondition.offerDeclined.isExists &&
          !offer.downsellCondition.offerDeclined.skip_offer
      );
            ...
            if (offers[i].discount.discountType === "INR") {
              ...
              if (topMessageIndex !== -1) {
                topMessage.splice(
                  topMessageIndex,
                  1,
                  `${superAssistantUser2_shopifyCurrency} ${offers[i].discount.discountValue}`
                );
              }
