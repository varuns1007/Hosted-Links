...
function selectWidgetLocation() {
  ...
  function position(pos, node) {
    ...
    // console.log(obj);
    axios
      .post("https://c1da735fde3e.ngrok.io/widgetSave", {
...
function checkOut() {
  ...
  checkoutButton[0].onclick = (e) => {
    e.preventDefault();
    axios
      .post("https://c1da735fde3e.ngrok.io/custom-checkout", {
        // or 'PUT'
        products,
        shopDomain,
      })
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://c1da735fde3e.ngrok.io/subtotalSave", {
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://c1da735fde3e.ngrok.io/totalSave", {
            className: event.target.classList[0],
            tagName: event.target.tagName.toLowerCase(),
            shopName: shopDomain,
          })
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://c1da735fde3e.ngrok.io/individualSave", {
            className: event.target.classList[0],
            tagName: event.target.tagName.toLowerCase(),
            shopName: shopDomain,
          })
