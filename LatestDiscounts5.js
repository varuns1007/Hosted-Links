                  ...
                  if (page === "collections") {
                    if (shopifyThemeId === 679) {
                      subTotal_Location = document.querySelectorAll(
                        ...
                        subTotal_Location = subTotal_Location[subTotal_Location.length-1];
                    }
                  }
              }
            }
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    let attribute = attributesCombine(
                      user.ajaxLocations.individualProduct_Ajax_Location
                        .attribute
                    );
                    let classes = classesCombine(
                      user.ajaxLocations.individualProduct_Ajax_Location
                ...
                products.forEach((each) => {
                  ...
                  if (discountObj.discountType === "%") {
                    ...
                    discount = discountObj.applicableDiscount;
                    discount =
                      discount * parseInt(each.originalProductQuantity);
                    console.log(discount);
                    // console.log(discount);
                    let individualPrice =
                      (productTotal - parseInt(discount)) /
                ...
                for (let i = 0; i < buyXgetYDiscounts.length; i++) {
                  ...
                  for (
                    ...
                    if (
                      cartItemIds.indexOf(
                        buyXgetYDiscounts[i].YproductId[j]
                      ) === -1
                    ) {
                      discountText.push(
                        createPtag(
