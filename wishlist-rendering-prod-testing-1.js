...
function startWishlist() {
  ...
  console.log(
    `🚀 ~ file: wishlist-rendering.js ~ line 284 ~ startWishlist ~${serverUrl}/db/save/user/${window.location.hostname}`
  );
  fetch(`${serverUrl}/db/save/user/${window.location.hostname}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      accept: "application/json",
    ...
    .then(function (response) {
      ...
      console.log("🚀 ~ file: wishlist-rendering.js ~ line 292 ~ data", data)
        ...
        if (data.Active) {
          ...
          wishlistButton.innerHTML = `<div id="superAssistant-heart_btn_wishlist" style="position: fixed;right: 2em;bottom: 2em;border: 3px solid grey;
    border-radius: 100%;
    padding: 0.8em;">
</div>`;
          ...
          //hiding all hearts when app is disabled
          setInterval(() => {
            let hearts = document.querySelectorAll(".button_wish_catalog");
            hearts.forEach(node => {
              node.innerHTML = "";
            })
...
function render_heart(data) {
  ...
  const wishlistUI = `<style>
    ...
    /* Modal Content */
    .superAssistant-modal-content_wishlist {
      position: relative;
      ...
      -webkit-animation-name: superAssistant-animatetop_wishlist;
      -webkit-animation-duration: 0.4s;
      animation-name: superAssistant-animatetop_wishlist;
      animation-duration: 0.4s
    }
    
    /* Add Animation */
    @-webkit-keyframes superAssistant-animatetop_wishlist {
      from {top:-300px; opacity:0} 
      to {top:0; opacity:1}
    }
    
    @keyframes superAssistant-animatetop_wishlist {
      from {top:-300px; opacity:0}
      to {top:0; opacity:1}
    }
    ...
    .superAssistant-modal-header_wishlist {
      padding: 1em;
    ...
    .superAssistant-modal-header_wishlist {padding: 2px 16px; height: 88.6%;min-height: 20vh;}

    .superAssistant-product_card_wishlist {
    ...
    .superAssistant-product_card_wishlist:hover {
        box-shadow: 0 8px 16px 0 rgba(0,0,0,0.4);
    }
    
    .superAssistant-prod_img_wishlist {
        border-radius: 5px 5px 0 0;
        width:100%;
        height:150px;
    }
    
    .superAssistant-card_container_wishlist {
        padding-inline: 0.4em;
    }
    .superAssistant-addtocart_btn_wishlist:hover{
        cursor: pointer;
    }
    
    .superAssistant-addtocart_btn_wishlist {
        background-color: ${data.CartColor};
        color: white;
        width: 100%;
        padding: 5px;
    ...
    .superAssistant-outofstock_btn_wishlist {
    ...
    .superAssistant-button_wishlistUI_wishlist { 
    ...
    .superAssistant-button_wishlistUI_wishlist:hover{
        cursor: pointer;
    }

    .superAssistant-modal-menu_wishlist{
        float: right;
    	padding: 8px;
    	margin-right: 15px;
    }
...
.SuperAssistant-ribbon span::after {
  ...
  border-top: 3px solid #0C35A7;
    ...
    <!-- The Modal -->
    <div id="superAssistant-myModal_wishlist" class="superAssistant-modal_wishlist">
    
      <!-- Modal content -->
      <div class="superAssistant-modal-content_wishlist">
        <div class="superAssistant-modal-header_wishlist">
          <span class="superAssistant-Wishlist-Close">&times;</span>
          <h2 style="/*color: white; */text-align:center">WISHLIST</h2>
        </div>
        <div class="superAssistant-modal-header_wishlist">
            <div style="display: flex; flex-wrap: wrap; " id="superAssistant-wishlist_grid_wishlist">
            </div>
            <div id='superAssistant-emptyMessage_wishlist' style=" margin: auto; text-align: center; padding: 10vh 0; ">No products were added to the wishlist. <br/> Continue Shopping !!</div>
        </div>
      </div>
  ...
  const heart_button = `<style>
    .superAssistant-heart_wish_wishlist {
    background-color: transparent;
    border: none;
    text-align: center;
    font-size: 1.5em;
    ...
    <button id='superAssistant-myBtn_wishlist' class='superAssistant-heart_wish_wishlist'><i class='fa fa-heart fa-2x' aria-hidden='true'></i></button>`;
  ...
  const star_button = `<style>
    ...
    <button id='superAssistant-myBtn_wishlist' class='superAssistant-heart_wish_wishlist'><i class="fa fa-star fa-2x" aria-hidden="true"></i></button>`;
  ...
  const thumbsup_button = `<style>
    ...
    <button id='superAssistant-myBtn_wishlist' class='superAssistant-heart_wish_wishlist'><i class="fa fa-thumbs-up fa-2x" aria-hidden="true"></i></button>`;
  ...
  const bookmark_button = `<style>
    ...
    <button id='superAssistant-myBtn_wishlist' class='superAssistant-heart_wish_wishlist'><i class="fa fa-bookmark fa-2x" aria-hidden="true"></i></button>`;

  if (data.CataIconType == "10") {
    document.querySelector("#superAssistant-heart_btn_wishlist").innerHTML = heart_button;
  }
  if (data.CataIconType == "11") {
    document.querySelector("#superAssistant-heart_btn_wishlist").innerHTML = star_button;
  }
  if (data.CataIconType == "12") {
    document.querySelector("#superAssistant-heart_btn_wishlist").innerHTML = thumbsup_button;
  }
  if (data.CataIconType == "13") {
    document.querySelector("#superAssistant-heart_btn_wishlist").innerHTML = bookmark_button;
  }

  document.querySelector("head").insertAdjacentHTML("afterend", wishlistUI);

  // Get the modal
  var modal = document.getElementById("superAssistant-myModal_wishlist");

  // Get the button that opens the modal
  var btn = document.getElementById("superAssistant-myBtn_wishlist");
  ...
  if (document.getElementById("superAssistant-wishlist_grid_wishlist").innerHTML == "") {
    document.getElementById("superAssistant-emptyMessage_wishlist").style.display = "block";
    return;
  } else {
    document.getElementById("superAssistant-emptyMessage_wishlist").style.display = "none";
    return;
  }
}
...
function renderItems(data) {
  ...
  <ins style="text-decoration: none; color:${data.CartColor} ; font-weight: 600">
    ${variantData.variant.price}
              ...
              const productCard = `<div class="superAssistant-product_card_wishlist" id="${productTitle} - ${variantTitle}">
                                                <button id="${variantid}" style="color:${data.CataIconColor}" data-item="${productTitle} - ${variantTitle}" class="superAssistant-button_wishlistUI_wishlist">
                                                    ${remove_wishlist}
                                                </button>
                                                ${saleDiv}
                                                <a href="${productUrl}" style="text-decoration: none; color:black;">
                                                    <img src="${productImg}" class="superAssistant-prod_img_wishlist" alt="${productTitle}">
                                                    <div class="superAssistant-card_container_wishlist">
                                                ...
                                                <div id="${variantid}" data-item="${productTitle} - ${variantTitle}" class="superAssistant-addtocart_btn_wishlist">
                                                    ${data.CartLabelBefore}
                                                </div>
                                            </div>`;
              const CartItemCard = `<div class="superAssistant-product_card_wishlist" id="${productTitle} - ${variantTitle}">
                                                <button id="${variantid}" style="color:${data.CataIconColor}" data-item="${productTitle} - ${variantTitle}" class="superAssistant-button_wishlistUI_wishlist">
                                                    ${remove_wishlist}
                                                </button>
                                                <a href="${productUrl}" style="text-decoration: none; color:black;">
              ...
              const OutofStockCard = `<div class="superAssistant-product_card_wishlist" id="${productTitle} - ${variantTitle}">
                                                <button id="${variantid}" style="color:${data.CataIconColor}" data-item="${productTitle} - ${variantTitle}" class="superAssistant-button_wishlistUI_wishlist">
                                                    ${remove_wishlist}
                                                </button>
                                                <a href="${productUrl}" style="text-decoration: none; color:black;">
                                                ...
                                                <div id="${variantid}" data-item="${productTitle} - ${variantTitle}" class="superAssistant-outofstock_btn_wishlist">
                                                    OUT OF STOCK
                                                </div>
                                            </div>`;
              if (inventory_quantity > 0) {
                document.getElementById("superAssistant-wishlist_grid_wishlist").innerHTML +=
                  productCard;
              } else
                document.getElementById("superAssistant-wishlist_grid_wishlist").innerHTML +=
                  OutofStockCard;
...
function buttonMethods(data) {
  var remove_btn = document.querySelectorAll("button.superAssistant-button_wishlistUI_wishlist");
  ...
  var cart_btn = document.querySelectorAll("div.superAssistant-addtocart_btn_wishlist");
...
function renderButton(data) {
  setTimeout(() => {
    ...
    .superAssistant-button_wish_1_wishlist {
    ...
    <button  id='superAssistant-wish_btn_wishlist' class="superAssistant-button_wish_1_wishlist">${label_Btn}</button>`;

    const wish_button_2 = `<style>
    .superAssistant-button_wish_2_wishlist {
    background-color: ${color_Btn};
    border: none;
    color: white;
    padding: 7px 14px;
    ...
    <button  id="superAssistant-wish_btn_wishlist" class="superAssistant-button_wish_2_wishlist">${icon_Btn}      ${label_Btn}</button>`;

    const wish_button_3 = `<style>
    .superAssistant-button_wish_3_wishlist {
    background-color: transparent;
    border: none;
    color: ${color_Btn};
    padding: 7px 14px;
    ...
    <button  id="superAssistant-wish_btn_wishlist" class="superAssistant-button_wish_3_wishlist">${label_Btn}</button>`;

    const wish_button_4 = `<style>
    .superAssistant-button_wish_4_wishlist {
    background-color: transparent;
    border: none;
    color: ${color_Btn};
    padding: 7px 14px;
    ...
    <button  id="superAssistant-wish_btn_wishlist" class="superAssistant-button_wish_4_wishlist">${icon_Btn}      ${label_Btn}</button>`;

    const wish_button_5 = `<style>
    .superAssistant-button_wish_5_wishlist {
    background-color: transparent;
    border: none;
    color: ${color_Btn};
    padding: 7px 14px;
    ...
    <button  id="superAssistant-wish_btn_wishlist" class="superAssistant-button_wish_5_wishlist">${icon_Btn}</button>`;
...
function initWishlist(
  ...
  if (Value == "1")
    document.querySelector("#superAssistant-wish_btn_product").innerHTML = wish_button_1;

  if (Value == "2")
    document.querySelector("#superAssistant-wish_btn_product").innerHTML = wish_button_2;

  if (Value == "3")
    document.querySelector("#superAssistant-wish_btn_product").innerHTML = wish_button_3;

  if (Value == "4")
    document.querySelector("#superAssistant-wish_btn_product").innerHTML = wish_button_4;

  if (Value == "5")
    document.querySelector("#superAssistant-wish_btn_product").innerHTML = wish_button_5;

  document.getElementById("superAssistant-wish_btn_wishlist").addEventListener("click", (event) => {
    if (!in_list) {
      add_variant();
      in_list = !in_list;
...
function changeButton(data, in_list) {
  // console.log(in_list);
  var btn = document.getElementById("superAssistant-wish_btn_wishlist");
  if (in_list) {
