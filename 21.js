...
function selectWidgetLocation() {
  ...
  function position(pos, node) {
    ...
    // console.log(obj);
    axios
      .post("https://6b5e83993072.ngrok.io/widgetSave", {})
      .then((result) => {
        console.log(result);
...
function checkOut() {
  ...
  checkoutButton[0].onclick = (e) => {
    e.preventDefault();
    axios
      .post("https://6b5e83993072.ngrok.io/custom-checkout", {
        // or 'PUT'
        products,
        shopDomain,
      })
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://6b5e83993072.ngrok.io/subtotalSave", {
            div: "test",
            shopName: shopDomain,
          })
          .then((result) => {
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://6b5e83993072.ngrok.io/totalSave", {
            div: "test",
            shopName: shopDomain,
          })
          .then((result) => {
  ...
  function shiftClick(event) {
    if (event.shiftKey) {
      ...
      if (window.confirm("Confirm Selection")) {
        ...
        axios
          .post("https://6b5e83993072.ngrok.io/individualSave", {
            div: "test",
            shopName: shopDomain,
          })
          .then((result) => {
